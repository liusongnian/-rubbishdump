...
{
    qDebug()<<"delete ~LogTableWidget";
	delete m;
}

void LogTableWidget::bind(RepositoryWrapperFrame *frame)
{
    qDebug()<<"bind(RepositoryWrapperFrame *frame";
	m->frame = frame;
    Q_ASSERT(m->frame);
}
...
void LogTableWidget::paintEvent(QPaintEvent *e)
{
	...
	qDebug()<<"LogTableWidget::1paintEvent";
	QTableWidget::paintEvent(e);
	qDebug()<<"LogTableWidget::2paintEvent";
