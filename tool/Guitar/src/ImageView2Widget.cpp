...
struct ImageView2Widget::Private {
	QMainWindow *mainwindow = nullptr;
	FileDiff2Widget *filediffwidget = nullptr;
//	FileDiff2Widget::DrawData *draw_data = nullptr;
...
ImageView2Widget::ImageView2Widget(QWidget *parent)
	: QWidget(parent)
	, m(new Private)
{
...
ImageView2Widget::~ImageView2Widget()
{
	delete m;
}

void ImageView2Widget::bind(QMainWindow *mainwindow, FileDiff2Widget *filediffwidget, QScrollBar *vsb, QScrollBar *hsb)
{
...
bool ImageView2Widget::hasFocus() const
{
	QWidget *w = qApp->focusWidget();
	return w && w != m->filediffwidget && w->isAncestorOf(this);
}

void ImageView2Widget::setLeftBorderVisible(bool f)
{
	m->draw_left_border = f;
}

void ImageView2Widget::internalScrollImage(double x, double y)
{
	m->image_scroll_x = x;
	m->image_scroll_y = y;
...
void ImageView2Widget::scrollImage(double x, double y)
{
...
void ImageView2Widget::refrectScrollBar()
{
	double e = 0.75;
...
QString ImageView2Widget::formatText(Document::Line const &line)
{
...
QSizeF ImageView2Widget::imageScrollRange() const
{
	QSize sz = imageSize();
...
void ImageView2Widget::setScrollBarRange(QScrollBar *h, QScrollBar *v)
{
	h->blockSignals(true);
	v->blockSignals(true);
	QSizeF sz = imageScrollRange();
...
void ImageView2Widget::updateScrollBarRange()
{
	setScrollBarRange(m->h_scroll_bar, m->v_scroll_bar);
}

QMainWindow *ImageView2Widget::mainwindow()
{
	return m->mainwindow;
}

QBrush ImageView2Widget::getTransparentBackgroundBrush()
{
#ifdef APP_GUITAR
...
bool ImageView2Widget::isValidImage() const
{
	return !m->pixmap.isNull() || (m->svg && m->svg->isValid());
}

QSize ImageView2Widget::imageSize() const
{
...
void ImageView2Widget::paintEvent(QPaintEvent *)
{
	QPainter pr(this);
...
void ImageView2Widget::resizeEvent(QResizeEvent *)
{
	updateScrollBarRange();
}

void ImageView2Widget::setImage(QString mimetype, QByteArray const &ba)
{
	if (mimetype.isEmpty()) {
...
void ImageView2Widget::mousePressEvent(QMouseEvent *e)
{
...
void ImageView2Widget::mouseMoveEvent(QMouseEvent *e)
{
	if (isValidImage()) {
		QPoint pos = mapFromGlobal(QCursor::pos());
...
void ImageView2Widget::setImageScale(double scale)
{
...
void ImageView2Widget::wheelEvent(QWheelEvent *e)
{
	if (isValidImage()) {
		double scale = 1;
