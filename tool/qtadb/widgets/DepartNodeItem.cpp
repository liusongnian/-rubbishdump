...
void DepartNodeItem::paintEvent(QPaintEvent *event)
{
...
#if 0
    {
        ...
        QPixmap pixmap(":/icons/images/arrow.png");
        ...
        painter.drawPixmap(m_indentation, (this->height() - pixmap.height()) / 2, tmpPixmap);
        painter.restore();
    }
#endif
