#ifndef STREAMNODEITEM_H
#define STREAMNODEITEM_H
...
namespace Ui {
class StreamNodeItem;
}

class StreamNodeItem : public QWidget
{
    Q_OBJECT

public:
    StreamNodeItem(QWidget *parent = 0);
    ~StreamNodeItem();
