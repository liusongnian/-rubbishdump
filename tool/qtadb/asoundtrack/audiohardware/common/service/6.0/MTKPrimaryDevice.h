...
using ::android::hardware::audio::common::V6_0::implementation::AudioInputFlagBitfield;
using ::android::hardware::audio::common::V6_0::implementation::AudioOutputFlagBitfield;
...
private:
    sp<android::hardware::audio::V6_0::implementation::Device> mDevice;
    // Methods from ::vendor::mediatek::hardware::audio::V6_1::IMTKPrimaryDevice follow.
