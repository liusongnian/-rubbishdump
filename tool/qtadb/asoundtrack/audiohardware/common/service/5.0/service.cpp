...
using android::hardware::registerPassthroughServiceImplementation;
using vendor::mediatek::hardware::bluetooth::audio::V2_1::IBluetoothAudioProvidersFactory;
...
int main(int /* argc */, char * /* argv */ []) {
    ...
    fail = registerPassthroughServiceImplementation<IBluetoothAudioProvidersFactory>() != OK;
    ALOGD("registered Bluetooth Audio API 2.1");
    ALOGW_IF(fail, "Could not register Bluetooth Audio API 2.1");
