...
#include <vendor/mediatek/hardware/audio/7.1/IAudioParameterChangedCallback.h>
#include <vendor/mediatek/hardware/audio/7.1/IMTKPrimaryDevice.h>
#include <vendor/mediatek/hardware/audio/7.1/IMTKPrimaryDeviceCallback.h>
...
using ::vendor::mediatek::hardware::audio::V7_1::IAudioParameterChangedCallback;
using ::vendor::mediatek::hardware::audio::V7_1::IMTKPrimaryDevice;
using ::vendor::mediatek::hardware::audio::V7_1::IMTKPrimaryDeviceCallback;
...
struct MTKPrimaryDevice : public IMTKPrimaryDevice {
    ...
    // Methods from IPrimaryDevice follow.
...
private:
    sp<android::hardware::audio::CPP_VERSION::implementation::Device> mDevice;
    // Methods from IMTKPrimaryDevice follow.
