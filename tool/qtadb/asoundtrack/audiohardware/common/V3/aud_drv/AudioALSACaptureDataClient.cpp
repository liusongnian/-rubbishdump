    ...
    //echoref---
{
    ...
    mBesRecordModeIndex = 0;
    mBesRecordSceneIndex = 0;
#endif
...
void AudioALSACaptureDataClient::ConfigBesRecordParams(void) {
    ...
    if (pSpeciParam == NULL || pCommonParam == NULL) {
    ...
    if (mStreamAttributeTarget->BesRecord_Info.besrecord_dmnr_tuningEnable == true) {
        ...
        if (pInFirParam == NULL || pOutFirParam == NULL) {
        ...
        if (pInFir1Param == NULL || pInFir2Param == NULL) {
