...
public:
    ...
    virtual status_t setFmAdspEnable(const bool enable);
#ifdef MTK_AUDIODSP_SUPPORT
    virtual status_t enableFmAdspTask(const bool enable, const audio_devices_t output_device);
#endif
    virtual bool     isFmAdspActive();
...
protected:
    ...
    audio_devices_t mOutput_device;
