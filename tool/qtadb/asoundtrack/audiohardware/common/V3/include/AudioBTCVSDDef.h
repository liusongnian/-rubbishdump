...
#define SCO_TX_PACKET_BUF_NUM        (3                              ) // reduce TX latency
...
#define SCO_RX_PACKET_BUF_NUM        (16                    )   //16
...
#define BTSCO_CVSD_TX_FRAME SCO_TX_PACKET_BUF_NUM
