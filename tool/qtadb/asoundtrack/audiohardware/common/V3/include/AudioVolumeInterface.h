...
public:
    ...
    */
    ...
    virtual status_t setVoiceVolume(int index __unused, int devices __unused, audio_mode_t mode __unused) { return -ENOSYS; }
...
#endif
    virtual status_t setAAudioPositiveGain(void) = 0;
};
