...
public:
    ...
    */
    ...
    //#endif
    // update speech fir
    bool UpdateOutputFIR(uint32_t mode, uint32_t index);
...
#if defined(MTK_A2DP_OFFLOAD_SUPPORT)
    AudioConfiguration mBluetoothAudioOffloadCodecConfig;
#endif

#if defined(MTK_TC10_FEATURE)
    void updateCustomSceneForVoIP();
