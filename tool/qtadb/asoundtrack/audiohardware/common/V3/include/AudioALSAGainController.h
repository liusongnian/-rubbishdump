...
public:
    ...
    virtual status_t     setAAudioMute(bool muteEnable);
    virtual status_t     setAAudioPositiveGain(void);
public:
...
public:
    ...
    virtual void         setAdcPga(uint32_t channel, int gain);
...
public:
    ...
    // return 0~255
    int GetDigitalLinearGain(uint32_t _volIdx, audio_devices_t _device, audio_stream_type_t _streamType);
    // return 0.0~1.0
...
private:
    ...
    uint32_t GetHeadphoneRGain(void);
    uint32_t GetHeadphoneLGain(void);
...
public:
    ...
    String8 getPlaybackCategoryString(void) { return mPlaybackCategory;};
    String8 getUlGainCategoryString(void) { return mUlGainCategory;};
    uint32_t GetReceiverGain(void);
    uint32_t GetSPKGain(void);
    uint32_t GetMicGain(void);
...
private:
    ...
    AudioALSADriverUtility *mDriverUtility;
    ...
    String8 mPlaybackCategory;
    String8 mUlGainCategory;
};
