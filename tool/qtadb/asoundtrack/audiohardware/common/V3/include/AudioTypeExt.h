...
const audio_source_t AUDIO_SOURCE_AAUDIO = (audio_source_t)84;
const audio_output_flags_t AUDIO_OUTPUT_FLAG_PLAYBACK = (audio_output_flags_t)2048; // 0x800
const audio_output_flags_t AUDIO_OUTPUT_FLAG_FM_ADSP = (audio_output_flags_t)4096; // 0x1000
const audio_source_t AUDIO_SOURCE_ODM_FM_RX = (audio_source_t)10;
