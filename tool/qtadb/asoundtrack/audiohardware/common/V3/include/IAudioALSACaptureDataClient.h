...
public:
    ...
    virtual const stream_attribute_t *getStreamAttributeTarget() { return NULL; }
    virtual void setStreamAttributeTargetDSP(stream_attribute_t attrDsp) { (void)attrDsp; }
    ...
    virtual AudioALSACaptureDataProviderBase *getCaptureDataProvider() = 0;
