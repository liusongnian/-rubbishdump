...
#define SPEECH_PARSER_CUST_SCENE     "CUSTOM_SCENE"
#define SPEECH_PARSER_CUST_INFO      "CUSTOM_INFO"
#define SPEECH_PARSER_DE_REVERB      "PHONE_CALL_DE_REVERB"
...
enum SpeechParamCustType {
    SPEECH_PARAM_CUST_TYPE_NONE = 0,
    SPEECH_PARAM_CUST_TYPE_DV = 1,
    SPEECH_PARAM_CUST_TYPE_TX = 2,
    NUM_SPEECH_PARAM_CUST_TYPE
};
...
typedef struct {
    ...
    uint8_t extraMode;
    uint8_t memoryIdx;
    uint8_t  __reserve_at_48byte[12];
