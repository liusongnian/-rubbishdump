...
public:
    ...
    void startKtvTask(const stream_attribute_t *attribute);
    void stopKtvTask(void);
    void setktvDspShareMem(bool enable);
...
protected:
    ...
    /* dsp pcm dump */
    void get_task_pcmdump_info(uint16_t task_id, uint16_t param1, void **pcm_dump);
    void set_task_pcmdump_info(uint16_t task_id, uint16_t param1, void *pcm_dump);
