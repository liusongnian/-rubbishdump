...
enum { /* sph_msg_id_t */
    ...
    MSG_A2M_MUTE_SPH_DYNAMIC_DL                 = 0x2F0A,
    ...
    MSG_A2M_FROM_CUST_NOTIFY_LOOPBACK_ACK       = 0x2FE4,
    ...
    MSG_M2A_MUTE_SPH_DYNAMIC_DL_ACK             = 0x8000 | MSG_A2M_MUTE_SPH_DYNAMIC_DL,
    ...
    MSG_M2A_FROM_CUST_NOTIFY_LOOPBACK           = 0x8000 | MSG_A2M_FROM_CUST_NOTIFY_LOOPBACK_ACK,
};
