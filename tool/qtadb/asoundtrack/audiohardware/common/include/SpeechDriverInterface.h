...
public:
     ...
     */
    virtual status_t TelephonyTxOn(uint16_t pcmTelephonyTxType __unused) { return -ENOSYS; }
    virtual status_t TelephonyTxConfig(uint16_t pcmTelephonyTxType __unused) { return -ENOSYS; }
    ...
    virtual status_t SetDynamicDownlinkMute(bool mute_on __unused) { return -ENOSYS; }
    virtual status_t SetUplinkMute(bool mute_on) = 0;
    virtual status_t SetUplinkSourceMute(bool mute_on) = 0;
    virtual void     setMuteInfo(uint32_t muteInfo __unused) { return; }
    ...
    virtual int updateCustScene(const char *custScene  __unused) { return -ENOSYS; }
    virtual int updateCustInfo(const char *custInfo  __unused) { return -ENOSYS; }
     ...
     * ecall
     */
    virtual status_t eCallIvsSwitch(bool enable  __unused) { return -ENOSYS; }
    virtual status_t eCallIvsSend() { return -ENOSYS; }
    virtual status_t eCallPsapSwitch(bool enable  __unused) { return -ENOSYS; }
    virtual status_t eCallPsapSend() { return -ENOSYS; }
    virtual status_t eCallCtrlSeqSwitch(bool enable  __unused) { return -ENOSYS; }
    virtual status_t eCallMsd(void *data  __unused, uint16_t len  __unused) { return -ENOSYS; }
    virtual status_t eCallTxCtrlParam(void *data  __unused, uint16_t len  __unused) { return -ENOSYS; }
    ...
    inline uint32_t getMDNetwork() {
        return mNetworkRate;
    }
    inline SPEECH_BAND getMDBand() {
        return mBand;
    }
     ...
     */
    void             WaitUntilSignaledOrTimeout(unsigned milisecond) { mMutex.lock(); mCondition.waitRelative(mMutex, milliseconds(milisecond)); mMutex.unlock(); return; }
    ...
    virtual void setBtHeadsetName(const char *bt_headset_name __unused) { return; }

    virtual int sendIpcCmd(int cmd __unused) { return -ENOSYS; }
...
protected:
    ...
    virtual void     CleanGainValueAndMuteStatus() {
        ...
        mDynamicDownlinkMuteOn = false;
        ALOGD("%s(), mUplinkMuteOn %d, mUplinkSourceMuteOn %d, mDownlinkMuteOn %d, mDynamicDownlinkMuteOn %d",
              __FUNCTION__, mUplinkMuteOn, mUplinkSourceMuteOn, mDownlinkMuteOn, mDynamicDownlinkMuteOn);
    }
    ...
    static uint8_t mIpcLpbkSwitch;
    static uint8_t mIpcPath;
    SPEECH_BAND mBand;
