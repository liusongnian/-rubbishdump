...
static const char     *kPropertyKeyFmChipId       = "persist.vendor.connsys.fm_chipid";
...
WCNChipController::WCNChipController() {
    ...
    char isFmSupport[PROPERTY_VALUE_MAX] = {};
    get_string_from_property(kPropertyKeyFmChipId, isFmSupport, PROPERTY_VALUE_MAX);
    mIsFmSupportFromProperty = (strlen(isFmSupport) > 0) ? true : false;
}
