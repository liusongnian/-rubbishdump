...
LOCAL_SRC_FILES += $(LOCAL_COMMON_PATH)/utility/audio_sw_mixer.c \
...
LOCAL_SRC_FILES+= \
    ...
    $(LOCAL_COMMON_PATH)/utility/audio_fmt_conv_hal.c \
    ...
    $(LOCAL_COMMON_PATH)/V3/aud_drv/AudioALSACaptureDataProviderEchoRefBase.cpp \
    ...
    $(LOCAL_COMMON_PATH)/V3/aud_drv/AudioFtm.cpp \
...
# not support additional MD data path for voip during phonecall
MTK_SPEECH_VOICE_MIXER_SUPPORT = no
