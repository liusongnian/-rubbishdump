...
#include "../widgets/Asoundinfowidget.h"
#include "../tinymix/readtinymix.h"
#include "../asoundtrack/asoundtrack.h"
#include "../asoundinfo/asoundinfo.h"
